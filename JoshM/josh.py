...
font1 = {'family':'serif','color':'black','size':27} #making a font style 
font2 = {'family':'serif','color':'black','size':19}
...
def energylive():
    fig, ax = plt.subplots(figsize=(20, 20)) #sets the size of the generated screen
